function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark)");function n(){e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode")}n(),e.addEventListener("change",n);const o=document.querySelector(".dark-mode-boton");o&&o.addEventListener("click",(function(){document.body.classList.toggle("dark-mode")}))}function eventListeners(){const e=document.querySelector(".mobile-menu");e&&e.addEventListener("click",navegacionResponsive)}function navegacionResponsive(){const e=document.querySelector(".navegacion");e&&e.classList.toggle("mostrar")}
